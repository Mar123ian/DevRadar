...
class Programmer(CreatedAndUpdatedAtMixin, models.Model):
    ...
    email = models.EmailField(unique=True, error_messages={'unique': 'Програмист/фирма с този имейл вече съществува!'})
    phone_number = models.CharField(unique=True, max_length=15, error_messages={'max_length': 'Максималната дължина е 15 символа!', 'unique': 'Програмист/фирма с този тел. номер вече съществува!'})
